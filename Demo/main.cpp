...
#if defined(_WIN32)
const char* PathToLibrary = "C:\\Work\\stcore\\Libraries\\MISBCore\\MisbCoreNative\\NativeLibrary\\bin\\Release\\net6.0\\win-x64\\publish\\MisbCoreNativeLib.dll";
...
#else
const char* PathToLibrary = "../../NativeLibrary/bin/Release/net6.0/linux-x64/publish/MisbCoreNativeLib.so";
//const char* PathToLibrary = "../../NativeLibrary/bin/Release/net6.0/linux-arm64/publish/MisbCoreNativeLib.so";
//const char* PathToLicenseFile = "/home/Licenses/MisbCoreLegion.lic";
const char* PathToLicenseFile = "/mnt/c/Users/al_1_/Google Drive/Doc/Impleo/Licenses/Impleo/MisbCoreNativeXpsWsl.lic";
//const char* LicenseKey = "D6D237EF-6F41CFAF-7A37BA74-6656A4E5";
const char* LicenseKey = "AF596BF0-BBAB142B-1B905B29-5DA51BED";
#endif
